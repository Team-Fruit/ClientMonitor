...
public final class Config extends Configuration {
	...
	{
		getCategory("Notification").setLanguageKey("clientmonitor.config.notification").setComment("Server requesting packet notifications");
	}
	public final @Nonnull ConfigProperty<Boolean> notifyChat = propertyBoolean(get("Notification", "Chat", false, "notify by chat").setLanguageKey("clientmonitor.config.notification.chat"));
	public final @Nonnull ConfigProperty<Boolean> notifyOverlay = propertyBoolean(get("Notification", "Overlay", false, "notify by overlay text").setLanguageKey("clientmonitor.config.notification.overlay"));
	public final @Nonnull ConfigProperty<Boolean> notifyEffect = propertyBoolean(get("Notification", "Effect", false, "notify by effect").setLanguageKey("clientmonitor.config.notification.effect"));
	public final @Nonnull ConfigProperty<Boolean> notifySound = propertyBoolean(get("Notification", "Sound", false, "notify by sound").setLanguageKey("clientmonitor.config.notification.sound"));
